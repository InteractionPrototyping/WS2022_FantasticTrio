...
import {
  ...
  utils_exports,
  view_default
} from "./chunk-MMQZLLKI.js";
import {
  getDocument,
  getWindow
} from "./chunk-XYBRFPVW.js";
...
var Calendar = function(_Framework7Class) {
  ...
  _proto.renderYearPicker = function renderYearPicker() {
    ...
    return jsx_default("div", {
      ...
      }, jsx_default("span", null, calendar.yearFormatter.format(new Date().setFullYear(year))));
    }));
  };
  _proto.renderTimeSelector = function renderTimeSelector() {
    ...
    var timeString;
    if (value)
      timeString = calendar.timeSelectorFormatter.format(value);
    return jsx_default("div", {
