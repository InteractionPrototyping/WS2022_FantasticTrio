...
function getChildren(slots, slotName) {
  ...
  var result = [];
  var getElementsChildren = function getElementsChildren2(els) {
    ...
    els.forEach(function(vnode) {
      ...
      if (isFragment && vnode.children) {
        getElementsChildren2(vnode.children);
...
var messages_default = {
  ...
  setup: function setup60(props, _ref) {
    var slots = _ref.slots;
    var f7Messages = null;
...
var panel_default = {
  ...
  setup: function setup68(props, _ref) {
    ...
    var classes = computed(function() {
      ...
      var effectComputed = props.effect || (props.reveal ? "reveal" : props.push ? "push" : "cover");
...
var tab_default = {
  ...
  setup: function setup83(props, _ref) {
    ...
    if (!routerData.value && route && route.route && route.route.tab && route.route.tab.id === props.id) {
      var _route$route$tab = route.route.tab, component = _route$route$tab.component, asyncComponent = _route$route$tab.asyncComponent, tabRouteOptions = _route$route$tab.options;
      if (component || asyncComponent) {
        ...
        initialTabContent = {
          ...
          props: _extends80({}, parentProps || {}, tabRouteOptions && tabRouteOptions.props || {}, {
            f7router: router,
            f7route: route
          }, route.params)
        };
...
var treeview_item_default = {
  ...
  setup: function setup86(props, _ref) {
    var slots = _ref.slots, emit = _ref.emit;
    var elRef = ref(null);
...
var treeview_default = {
  name: "f7-treeview",
  render: render83,
  props: _extends84({}, colorProps),
  setup: function setup87(props) {
    var classes = computed(function() {
...
var view_default = {
  ...
  setup: function setup88(props, _ref) {
    ...
    var getViewParams = function getViewParams2() {
      ...
      return noUndefinedProps(_extends86({}, props, {
        routes,
        routesAdd
      }));
    };
    if (f7 && !f7View && props.init) {
      ...
      f7View = f7.views.create(elRef.value, _extends86({}, getViewParams(), {
        routerId,
        init: false,
        on: {
          init: onViewInit
    ...
    onMounted(function() {
      f7ready(function() {
        if (f7View) {
          ...
          f7routers.views.push(routerData);
          routerData.instance = f7.views.create(elRef.value, _extends86({
            routerId: _routerId
          }, getViewParams(), {
            on: {
              init: onViewInit
    ...
    return function() {
      return h("div", {
        ...
        return h(getComponent(page), _extends86({
          key: page.id
        }, getProps(page)));
      })));
    };
...
//# sourceMappingURL=chunk-NINE4TMQ.js.map
