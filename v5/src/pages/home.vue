<template>
  <f7-page name="home">
    ...
    <!-- Extended FAB Center Bottom to add a request-->
    <template #fixed>
      <f7-fab
        href="/add-request/"
    ...
    <div class="list media-list">
      <ul>
        <!--Swipeout function to delete request-->
        <li class="swipeout" v-for="item in list" v-bind:key="item">
          ...
          <!-- button to check interested helpers -->
          <f7-row style="margin: 10px 15px">
            <f7-col>
              <f7-button
                fill
                @click="checkHelper(item)"
          ...
          <!-- swipeout function: confirm deletion-->
    ...
    <div class="list media-list">
      <ul style="filter：gray; -moz-opacity:.3;opacity:0.3;paddinng;0px">
        <!--swipe-out function to delete request-->
      ...
      list: [
        {
          ...
          img: "https://i.imgur.com/dMo0n91.jpg",
          interested: "3",
        ...
        },
        {
          ...
          date: "23/01/2022",
          text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sagittis tellus ut turpis condimentum, ut dignissim lacus tincidunt. Cras dolor metus, ultrices condimentum sodales sit amet, pharetra sodales eros. Phasellus vel felis tellus. Mauris rutrum ligula nec dapibus feugiat. In vel dui laoreet, commodo augue id, pulvinar lacus.",
          img: "https://images.pexels.com/photos/994164/pexels-photo-994164.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
          interested: "1",
          link: "/interested-helper/",
        },
        {
          ...
          date: "24/01/2022",
          text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sagittis tellus ut turpis condimentum, ut dignissim lacus tincidunt. Cras dolor metus, ultrices condimentum sodales sit amet, pharetra sodales eros. Phasellus vel felis tellus. Mauris rutrum ligula nec dapibus feugiat. In vel dui laoreet, commodo augue id, pulvinar lacus.",
          img: "https://images.pexels.com/photos/2762247/pexels-photo-2762247.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
          interested: "2",
          link: "/interested-helper/",
        },
      ],
      // initial requests data of finished list
      finishedList: [
        {
          title: "Four walls of the bedroom need to be renovated and painted",
          keyword: "Paint wall",
