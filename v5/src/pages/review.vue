<template>
  <f7-page name="review">
    <!--Navbar-->
    <f7-navbar title="Reviews" back-link="Back" style="font-size: 20px"></f7-navbar>
    ...
    <f7-block>
      ...
      <f7-row no-gap>
        ...
        <f7-col>
          ...
          <f7-icon f7="star_fill" size="25px" class="star"></f7-icon>
          <f7-icon f7="star_fill" size="25px" class="star"></f7-icon>
          <f7-icon f7="star_empty" size="25px" class="star"></f7-icon>
  ...
  <!-- Menu item with dropdown option-->
    ...
    <f7-list media-list>
      ...
      >
        <!--Profile picture-->
        <template #media>
            <img src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="avatar"/>
          </template>
      </f7-list-item>
      ...
      >
        <!--Profile picture-->
        <template #media>
            <img src="https://images.pexels.com/photos/5486199/pexels-photo-5486199.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="avatar"/>
          </template>
      </f7-list-item>
      ...
      >
        <!--Profile picture-->
        <template #media>
            <img src="https://images.pexels.com/photos/1858175/pexels-photo-1858175.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="avatar"/>
          </template>
      </f7-list-item>
      ...
      >
        <!--Profile picture-->
        <template #media>
            <img src="https://images.pexels.com/photos/38554/girl-people-landscape-sun-38554.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="avatar"/>
          </template>
      </f7-list-item>
      ...
      >
        <!--Profile picture-->
        <template #media>
            <img src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="avatar"/>
          </template>
      </f7-list-item>
    </f7-list>
    </f7-block>
...
.block-title{
  --f7-block-title-font-size: 40px;
  --f7-block-title-font-weight: bold;
  --f7-block-title-text-color: #2D4066;
}
div{
  font-size: 20px;
}
