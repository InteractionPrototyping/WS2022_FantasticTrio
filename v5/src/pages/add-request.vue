    ...
    <f7-list no-hairlines-md>
      ...
      >
        <select name="keyword">
          ...
          <optgroup
            label="<img style='width:25px; height:25px;' src='../img/add_request_keyword/home.svg'>House, Exterior work"
          >
          ...
          <optgroup
            label="<img style='width:25px; height:25px;' src='../img/add_request_keyword/painting.svg'>House, Interior work"
          >
          ...
          <optgroup
            label=" <img style='width:25px; height:25px;' src='../img/add_request_keyword/gardening.svg'>Gardening"
          >
