<template>
  <f7-page name="chat">
    <f7-navbar back-link="Back">
        ...
        <f7-icon fill f7="phone_fill" size=30px class="right" style="color:red"></f7-icon>
    </f7-navbar>
    <f7-block>
      <img src="https://images.pexels.com/photos/2691608/pexels-photo-2691608.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" width="120"/>
      <f7-list media-list>
      <f7-list-item
        title="Jack.M"
        after="Car repair"
    ...
    return {
      ...
      messagesData: [
        ...
        },
        {
          ...
          avatar: 'https://images.pexels.com/photos/2691608/pexels-photo-2691608.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
        },
        {
          type: 'sent',
