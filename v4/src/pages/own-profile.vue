...
export default {
      ...
      msg:'adf',
            list:[
              ...
              { title:"A tip to keep you garden clean",
                img_header: "background-image:url(https://images.pexels.com/photos/1065874/pexels-photo-1065874.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)",
              ...
              { title:"Eletronics is not difficult！！",
                img_header: "background-image:url(https://images.pexels.com/photos/3912983/pexels-photo-3912983.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)",
              ...
              { title:"Assembling furnitures with ...",
                img_header: "background-image:url(https://images.pexels.com/photos/5691613/pexels-photo-5691613.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)",
              ...
              { title:"Teach you to replace the bulb",
                img_header: "background-image:url(https://images.pexels.com/photos/6211091/pexels-photo-6211091.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)",
  ...
  computed: {
    activeList() {
      return this.list.filter((item) => item.like_type == "suit_heart_fill"&item.id<3)
    }
  },
    beforeCreate(){
